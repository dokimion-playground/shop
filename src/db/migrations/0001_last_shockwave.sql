CREATE TABLE "tickets" (
	...
	"description" text,
	"compeleted" boolean DEFAULT false NOT NULL,
...
ALTER TABLE "customers" ADD COLUMN "address2" varchar NOT NULL;--> statement-breakpoint
...
ALTER TABLE "customers" DROP COLUMN "compeleted";--> statement-breakpoint
